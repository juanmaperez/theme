...
<html lang="<?php bloginfo('language'); ?>">
  ...
  <body>
    ...
    <header>
      ...
      <!-- Hero -->
      <div class="jumbotron hero" style="background-image: url('<?php echo ic_theme_blog( 'header-image' ) ?>')">
        <div class="hero-caption"<?php ic_theme_blog( 'hero-mask' ) ?>>
          <div class="title-container">
            <?php ic_theme_blog( 'title' ); ?>
            <?php ic_theme_blog( 'subtitle' ); ?>
          </div>
        </div>
      </div>
    </header>
